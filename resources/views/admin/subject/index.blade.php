                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach ($subjects as $key => $subject)
                                        <tr>
                                            ...
                                            <td>
                                                @if($subject->id !== 1)
                                                 <a class="btn btn-sm btn-primary fa fa-edit" href="{{ route('admin.subject.edit',$subject->id) }}" title="Edit"></a>
                                                   @can('delete')
                                                       {!! Form::button('<i class="fa fa-trash"></i> ', ['title' => 'Delete', 'class' => 'btn btn-sm btn-danger bold uppercase delete_button','data-toggle'=>"modal",'data-target'=>"#DelModal",'data-id'=>$subject->id]) !!}
                                                   @endcan
                                                @endif
                                            </td>
                                        </tr>
