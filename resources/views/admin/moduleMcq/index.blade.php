                        ...
                        <div class="card-header">
                            ...
                            <div class="pull-right box-tools">
                                <div class="float-right mt-1">
                                    <a class="btn btn-primary uppercase text-bold" href="{{ route('admin.moduleMcq.create') }}">New moduleMcq Add</a>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-bold text-uppercase">module Mcq name </th>
                                        <th class="text-bold text-uppercase">Action</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach ($moduleMcq as $key => $moduleMcq)


                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            <td>{{ $moduleMcq->moduleName }}</td>


                                            <td>
                                                @if($moduleMcq->id !== 1)
                                                 <a class="btn btn-sm btn-primary fa fa-edit" href="{{ route('admin.moduleMcq.edit',$moduleMcq->id) }}" title="Edit"></a>
                                                   @can('delete')
                                                       {!! Form::button('<i class="fa fa-trash"></i> ', ['title' => 'Delete', 'class' => 'btn btn-sm btn-danger bold uppercase delete_button','data-toggle'=>"modal",'data-target'=>"#DelModal",'data-id'=>$moduleMcq->id]) !!}
                                                   @endcan
                                                @endif
                                            </td>
                                        </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    <form action="{{route('admin.moduleMcq.destroy',0)}}" method="post" id="deleteForm">
    ...
    <script>
        $(document).ready(function () {
            $(document).on("click", '.delete_button', function (e) {
                var id = $(this).data('id');
                var url = '{{ route("admin.moduleMcq.destroy",":id") }}';
