            ...
            <div class="card-header">
                ...
                <div class="pull-right box-tools">
                    <div class="float-right mt-1">
                        <a class="btn btn-primary uppercase text-bold" href="{{ route('admin.module.assign.index') }}"> Back</a>
                    </div>
                </div>
            </div>
                <div class="card-body">
                    <form id="subjectForm">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="Course_id" id="moduleId" class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="Subject_id" id="examId" class="form-control">
                                        @foreach ($AssignExam as $AssignExam)
                                          <option value="{{ $AssignExam->id }}">{{ $AssignExam->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary float-right">Add Assign Module</button>
                        </div>
                    </form>
                </div>
            <!-- /.card -->
...
<script>
    $(document).ready(function () {
        $('#subjectForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route("admin.module.assign.store") }}', // Replace with your route name or URL
                type: 'POST',
                data: formData,
